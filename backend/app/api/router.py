...
from app.api.routes import changes, health, risk, runs, validations

api_router = APIRouter()
api_router.include_router(health.router)
# F5.x / F6.x operations — fixed API path prefix (not a general versioning system).
...
api_router.include_router(validations.router, prefix="/api/v1")
